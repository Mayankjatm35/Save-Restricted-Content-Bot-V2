...
def get_user_rename_preference(user_id):
    # Retrieve the user's custom renaming tag if set, or default to 'Warrior Units'
    return user_rename_preferences.get(str(user_id), 'Warrior Units')
...
async def callback_query_handler(event):
    ...
    if event.data == b'setchat':
        ...
        await event.edit("Choose your preferred upload method:\n\n__**Note:** **SpyLib ⚡**, built on Telethon(base), by Warrior Units still in beta.__", buttons=buttons)
